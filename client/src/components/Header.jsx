...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
      <div className='text-stone-500 incline-flex text-center gap-2 bg-white
      ...
      <h1 className='text-4xl max-w-[600px] sm:text-7xl sm:max-w-[500px] mx-auto mt-10 text-center'>
